...
export const translations: Record<Language, any> = {
  en: {
    ...
    footer: { faq: 'FAQ', contact: 'Contact Us', rights: 'All Rights Reserved.', location: 'Dance Studio Seoul' },
  ...
  ko: {
    ...
    footer: { faq: '자주 묻는 질문', contact: '문의하기', rights: '모든 권리 보유.', location: '서울 댄스 스튜디오' },
  ...
  ja: {
    ...
    tour: { title: 'スタジオの\nバーチャルツアー', cta: 'ツアー開始' },
    footer: { faq: 'よくある質問', contact: 'お問い合わせ', rights: 'All Rights Reserved.', location: 'ダンススタジオ ソウル' },
  ...
  zh: {
    ...
    tour: { title: '参观我们的\n虚拟工作室', cta: '开始参观' },
    footer: { faq: '常见问题', contact: '联系我们', rights: '保留所有权利。', location: '首尔舞蹈工作室' },
